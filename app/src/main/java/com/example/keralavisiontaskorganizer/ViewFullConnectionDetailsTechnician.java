...
public class ViewFullConnectionDetailsTechnician extends AppCompatActivity {
    ...
    TextView name,phonenumber,address,task,priority,discripton;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_view_full_connection_details_technician);
