...
public class RecyclerTechmicianConnectionAdapter  extends RecyclerView.Adapter<TechnicianConnectionView> {
    ...
    public RecyclerTechmicianConnectionAdapter(Context context, List<String> name, List<String> address, List<String> priority, List<String> task) {
    ...
    @NonNull
    @Override
    public TechnicianConnectionView onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.technician_connection_item, parent, false);
        return new TechnicianConnectionView(context,itemView,name);
    }

    @Override
    public void onBindViewHolder(@NonNull TechnicianConnectionView holder, int position) {
