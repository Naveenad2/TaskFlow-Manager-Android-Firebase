...
public class AdminChatView  extends RecyclerView.ViewHolder {

    public TextView itemText;
    public Button itemButton;
    private Context context;

    public AdminChatView(@NonNull View itemView, List<String> item, Context context) {
        super(itemView);
        this.context = context;
        itemText = itemView.findViewById(R.id.adminChatsitemText);
        itemButton = itemView.findViewById(R.id.recyclerViewChatsButton);
