...
public class NewConnectionModel {
    ...
    NewConnectionModel(String name, String phoneNumber, String address, String discription, String priority, String task,String AllreadyDone,String allreadyDoneUid){
