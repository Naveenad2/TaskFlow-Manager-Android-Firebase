...
public class RecyclerCollectionAdapter extends RecyclerView.Adapter<CollectionViewitem>  {
    ...
    public RecyclerCollectionAdapter(Context context, List<String> name, List<String> phoneNumber, List<String> priority,List<String> allreadyDone) {
    ...
    @NonNull
    @Override
    public CollectionViewitem onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.collection_controller_item, parent, false);
        return new CollectionViewitem(context,itemView,name);
    }

    @Override
    public void onBindViewHolder(@NonNull CollectionViewitem holder, int position) {
