 ...
 * Use the {@link OperatorPublicFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class OperatorPublicFragment extends Fragment {

   RecyclerView recyclerView;
   RecyclerAdapterAllTask recyclerAdapterAllTask;
     ...
     * @return A new instance of fragment OperatorPublicFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static OperatorPublicFragment newInstance(String param1, String param2) {
        OperatorPublicFragment fragment = new OperatorPublicFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_operator_public, container, false);


        newConnectionButton = rootView.findViewById(R.id.newConnectionButton);

        newConnectionButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getContext(),AddNewConnectionField.class);
                startActivity(intent);
            }
        });


        recyclerView = rootView.findViewById(R.id.allTaskRecyclerview);
        LinearLayoutManager layoutManager = new LinearLayoutManager(getActivity());
        recyclerView.setLayoutManager(layoutManager);
        List<String> user =  getNewConnectionData();
        recyclerAdapterAllTask = new RecyclerAdapterAllTask(getContext(),name,address,priority,task,allreadyDone);
        recyclerView.setAdapter(recyclerAdapterAllTask);
    ...
    private List<String> getNewConnectionData() {
        ...
        usersRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                recyclerAdapterAllTask.setData(getData(name));
